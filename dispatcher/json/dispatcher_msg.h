...
////////////////////////////////////////////////////////////////////////////////
#ifndef __dispatcher_msg_20180831102825_h__
#define __dispatcher_msg_20180831102825_h__
...
struct DispatcherStat_t
{
    ...
    void skip_day() { __skip_day = true; }
    void skip_statOk() { __skip_statOk = true; }
    void skip_statOkE8c() { __skip_statOkE8c = true; }
    void skip_statErrSn() { __skip_statErrSn = true; }
    void skip_statErrMd5() { __skip_statErrMd5 = true; }

    bool json_has_day() const { return __json_has_day; }
    bool json_has_statOk() const { return __json_has_statOk; }
    bool json_has_statOkE8c() const { return __json_has_statOkE8c; }
    bool json_has_statErrSn() const { return __json_has_statErrSn; }
    bool json_has_statErrMd5() const { return __json_has_statErrMd5; }

    DispatcherStat_t();
    DispatcherStat_t& operator=(const DispatcherStat_t& obj_val);
    bool operator==(const DispatcherStat_t& obj_val) const;
    bool encode(allocator_t& alloc, rapidjson::Value& json_val) const;
    bool decode(const rapidjson::Value& json_val);
...
private:
    bool __skip_day;
    bool __skip_statOk;
    bool __skip_statOkE8c;
    bool __skip_statErrSn;
    bool __skip_statErrMd5;

    bool __json_has_day;
    bool __json_has_statOk;
    bool __json_has_statOkE8c;
    bool __json_has_statErrSn;
    bool __json_has_statErrMd5;
};
...
#endif // __dispatcher_msg_20180831102825_h__