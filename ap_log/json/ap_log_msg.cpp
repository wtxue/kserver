...
ap_log_db_t& ap_log_db_t::operator=(const ap_log_db_t& obj_val)
{
...
bool ap_log_db_t::operator==(const ap_log_db_t& obj_val) const
{
...
bool ap_log_db_t::encode(allocator_t& alloc, rapidjson::Value& json_val) const
{
    do
    {
        json_val.SetObject();
...
bool ap_log_db_t::decode(const rapidjson::Value& json_val)
{
    do
    {
